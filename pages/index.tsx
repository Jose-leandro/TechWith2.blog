...
export default function Index() {
  return (
    <>
      <Head>
        <title>
          TechWith2: Learn Programming, Stay Updated on Software Development & Tech Trends
        </title>
        <meta
          name="description"
        ...
        <meta name="keywords" content="JavaScript, React, Tailwind CSS, programming tutorials, software development, tech news, coding tips" />
        <meta name="author" content="José Leandro" />
        <meta property="og:title" content="TechWith2: Learn Programming, Stay Updated on Software Development & Tech Trends" />
        <meta property="og:description" content="TechWith2 offers programming tutorials, software development tips, and the latest tech trends. Explore in-depth insights and stay ahead in the digital world." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/your-image.jpg" /> {/* You can add a suitable image for better sharing */}
        <meta property="og:url" content="https://www.yourwebsite.com" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="TechWith2: Learn Programming, Stay Updated on Software Development & Tech Trends" />
        <meta name="twitter:description" content="TechWith2 offers programming tutorials, software development tips, and the latest tech trends. Explore in-depth insights and stay ahead in the digital world." />
        <meta name="twitter:image" content="/your-image.jpg" /> {/* Twitter image */}
      </Head>

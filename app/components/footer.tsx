...
const dateFooter = [
    { title: "Facebook", link: "https://www.facebook.com/profile.php?id=61574393784225&locale=pt_BR" },
    { title: "Instagram", link: "https://www.instagram.com/tech_with_2?utm_source=qr&igsh=NHJvdTBhcGU1bHV3" },
    { title: "X", link: "https://x.com/Tech_With2?t=vV0jHYNRbKSXP0T7zkk9oA&s=09" },
  ]
    ...
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm mt-6">
          ...
          <FooterSection
            title="Company"
            dateFooter={[
              { title: "What is TechWith2", link: "/about" },
            ]}
          />
          <FooterSection
            title="Help"
